 ...
 * but still loading options is rendered
 */
(0, _jestInCase2.default)('load options props with', function (_ref2) {
  var props = _ref2.props,
      expectloadOptionsLength = _ref2.expectloadOptionsLength;

  var asyncSelectWrapper = (0, _enzyme.mount)(_react2.default.createElement(_Async2.default, props));
...
test.skip('to not call loadOptions again for same value when cacheOptions is true', function () {
  ...
  var asyncSelectWrapper = (0, _enzyme.mount)(_react2.default.createElement(_Async2.default, { loadOptions: loadOptionsSpy, cacheOptions: true }));
  var inputValueWrapper = asyncSelectWrapper.find('div.react-select__input input');
