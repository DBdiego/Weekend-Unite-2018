...
(0, _jestInCase2.default)('current filter text is an exact match for an existing option', function (_ref) {
...
(0, _jestInCase2.default)('filterOptions returns invalid value', function (_ref2) {
...
(0, _jestInCase2.default)('filter text does not match any existing options', function (_ref3) {
